...
try {
  ...
  if (!$nombre1) {
     ...
     * cláusula catch. */
    throw new Exception("Falta Nombre de la Biblioteca.");
  } elseif (!$nombre2) {
    throw new Exception("Falta Direccion.");
  }
   ...
   */
  $respuesta = "Ingresando nueva Biblioteca con el nombre $nombre1 en la direccion $nombre2.";
} catch (Exception $e) {
  ...
  <body>
    ...
    <form>
      <p>
        ...
        inyección de código.
        -->
        <input type="text" name="nombre1" placeholder="Biblioteca"
                accesskey="1" value="<?=$nombre1Esc?>">
      </p>
      <p>
        <input type="text" name="nombre2" placeholder="Direccion"
